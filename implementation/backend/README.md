...
# Clawr Backend Implementation

This document describes the implementation of the [Clawr example compiler](https://github.com/clawrlang/clawr).

The [Clawr example compiler](https://github.com/clawrlang/clawr) is separated in two parts, a [frontend](../frontend/README.md) and a [backend](./README.md). The protocol between the two is described in the [official specification](../../cir-reference/README.md).

This section discusses the backend implementation.
